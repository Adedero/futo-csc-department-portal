...
const { data: student } = await useGet(`/api/student/profile`, {
  router,
  toast
});
...
const edit = ref({...student.value});

const loading = ref(false);
const saveEdit = async () => {
  loading.value = true;
  await usePost(`/api/student/update-profile/${student.value.userId}/student`,
    { method: 'PUT', body: edit.value, router, toast, toastOnSuccess: true, toastLife: 2000 },
    () => {
      editing.value = false;
      student.value = edit.value;
    }
  );
  loading.value = false;
}
...
<template>
  <main class="w-full h-full overflow-y-auto p-2 grid content-start gap-3 md:grid-cols-10 lg:grid-cols-12 xl:grid-cols-9">
    <VCard class="h-fit md:col-span-10 lg:col-span-12 xl:col-span-9">
      <h1 class="font-bold text-xl">Profile</h1>
    </VCard>

    <aside class="border bg-white rounded-md p-5 md:border-0 md:bg-transparent md:rounded-none md:p-0 md:overflow-y-auto md:col-span-3 lg:col-span-3 xl:col-span-2">
      <StudentInfoEditor :student @image-change="(url) => (student.image = url)" />
    </aside>
    ...
    <div class="h-[calc(100dvh-10rem)] grid gap-3 md:overflow-y-auto md:col-span-7 lg:col-span-9 xl:col-span-7">
      <VCard>
        <div class="flex items-center gap-2 justify-between">
          ...
          <div class="flex items-center gap-2">
            <Button @click="editing = !editing" :icon="editing ? 'pi pi-times' : 'pi pi-user-edit'"
              :severity="editing ? 'danger' : 'primary'" :outlined="editing" rounded />
        ...
        <Message v-show="!student.email" severity="warn">
        ...
        <div class="mt-2 grid gap-3 md:grid-cols-2 lg:grid-cols-6">
          <div v-if="!editing" class="grid gap-1 lg:col-span-2">
            ...
            <InputText :value="student.username" readonly type="text" fluid />
          </div>

          <div class="grid gap-1 lg:col-span-2">
            <label class="text-sm font-medium">Date of Birth</label>
            <InputText v-if="!editing" :value="student.dateOfBirth" readonly type="text" id="date-of-birth" fluid />
          ...
          <div class="grid gap-1 lg:col-span-2">
            ...
            <InputText v-if="!editing" :value="student.sex" readonly type="text" fluid />
          ...
          <div class="grid gap-1 lg:col-span-2">
            ...
            <InputText v-if="!editing" :value="student.phoneNumber" readonly type="text" fluid />
          ...
          <div :class="['grid gap-1 md:col-span-2', editing ? 'lg:col-span-6' : 'lg:col-span-4']">
            ...
            <InputText v-if="!editing" :value="student.email" readonly type="text" fluid />
          ...
          <div class="grid gap-1 lg:col-span-3">
            ...
            <InputText v-if="!editing" :value="student.nationality" readonly type="text" fluid />
          ...
          <div class="grid gap-1 lg:col-span-3">
            ...
            <InputText v-if="!editing" :value="student.stateOfOrigin" readonly type="text" fluid />
          ...
          <div class="grid gap-1 md:col-span-2 lg:col-span-6">
            ...
            <InputText v-if="!editing" :value="student.address" readonly type="text" fluid />
