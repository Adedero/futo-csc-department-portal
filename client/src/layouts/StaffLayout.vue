...
const routes = ref([
  { id: 1, name: 'staff-dashboard', label: 'Dashboard', icon: 'pi pi-home' },
  { id: 2, name: 'staff-results', label: 'Results', icon: 'pi pi-book' },
  { id: 3, name: 'staff-account', label: 'Account', icon: 'pi pi-user' }
])
</script>
    ...
    <template #navbar="{ toggle }">
      <div class="w-full h-full bg-white">
        <div class="text-center p-3 h-44">
          ...
          <small class="text-red-500">STAFF</small>
        </div>
