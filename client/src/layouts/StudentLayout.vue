...
const routes = ref([
  { id: 1, name: 'student-dashboard', label: 'Dashboard', icon: 'pi pi-home' },
  { id: 2, name: 'student-courses', label: 'Courses', icon: 'pi pi-book' },
  { id: 3, name: 'student-results', label: 'Results', icon: 'pi pi-graduation-cap' },
  { id: 4, name: 'student-account', label: 'Account', icon: 'pi pi-user' }
])
</script>
