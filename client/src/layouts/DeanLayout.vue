...
const routes = ref([
  { id: 1, name: 'dean-dashboard', label: 'Dashboard', icon: 'pi pi-home' },
  { id: 2, name: 'dean-results', label: 'Results', icon: 'pi pi-file' },
  { id: 3, name: 'dean-account', label: 'Account', icon: 'pi pi-user' }
])
</script>
    ...
    <template #navbar="{ toggle }">
      <div class="w-full h-full bg-white">
        <div class="text-center p-3 h-44">
          ...
          <small class="text-red-500">DEAN, SICT</small>
        </div>
